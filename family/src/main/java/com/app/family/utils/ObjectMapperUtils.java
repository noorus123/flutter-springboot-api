 ...
 *//**
	 ...
	 */
/*
 * public static <D, T> D map(final T entity, Class<D> outClass) { return
 ...
 * outCLass) { return entityList.stream() .map(entity -> map(entity, outCLass))
 ...
 *//**
	 ...
	 *//*
		 ...
		 * modelMapper.map(source, destination); return destination; }
		 * 
		 * 
		 * }
		 */